...
use ts_keys::{DerpServerKey, NodeKey, Pair, Public};
    ...
    Io: AsyncRead + AsyncWrite,
{
    ...
    pub async fn handshake(conn: Io, node_keypair: &Pair<NodeKey>) -> Result<Self, Error> {
    ...
    pub async fn send_one(&self, node_key: Public<NodeKey>, msg: &[u8]) -> Result<(), Error> {
    ...
    pub async fn recv_one(&self) -> Result<(Public<NodeKey>, PacketMut), Error> {
...
fn make_clientinfo(
    node_keypair: &Pair<NodeKey>,
    server_key: &Public<DerpServerKey>,
