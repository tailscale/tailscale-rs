...
use crate::{
    netcore,
    netcore::{Command, HasChannel, raw, tcp, udp},
    netsock::{RawSocket, TcpListener, TcpStream, UdpSocket},
    try_response_as,
};
    ...
    T: HasChannel + Sync,
{
    fn udp_bind_blocking(&self, endpoint: SocketAddr) -> Result<UdpSocket, netcore::Error> {
        ...
        try_response_as!(resp, udp::Response::Bound { local, handle });
    ...
    fn tcp_listen_blocking(
        ...
        try_response_as!(resp, tcp::listen::Response::Listening { handle });
    ...
    fn tcp_connect_blocking(
        ...
        try_response_as!(resp, tcp::stream::Response::Connected { handle });
    ...
    fn raw_open_blocking(
        ...
        try_response_as!(resp, raw::Response::Opened { handle });
