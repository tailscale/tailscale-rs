...
remote end of that channel is provided by [`netsock`][crate::netsock].
...
Compare the examples in [`netsock`][crate::netsock] and [the crate root][crate] (which
